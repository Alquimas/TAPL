...
open Format
open String
open Fullsimple.Support.Pervasive
open Fullsimple.Support.Error
open Fullsimple.Syntax
open Fullsimple.Core

module Lexer = Fullsimple.Lexer
module Parser = Fullsimple.Parser
let searchpath = ref [""]
